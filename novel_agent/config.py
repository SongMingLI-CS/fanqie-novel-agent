...
class Config:
    ...
    thinking: str = os.getenv("DEEPSEEK_THINKING", "disabled")
    reasoning_effort: str = os.getenv("DEEPSEEK_REASONING_EFFORT", "low")
    max_tokens: int = int(os.getenv("NOVEL_MAX_CHAPTER_TOKENS", "6000"))
    max_retries: int = max(0, min(2, int(os.getenv("NOVEL_MAX_RETRIES", "2"))))
